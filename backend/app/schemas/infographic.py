...
class InfographicSection(BaseModel):
    ...
    key_points: List[str] = Field(
        default_factory=list, description="Key points or bullet items for this section"
    )
    detail: Optional[str] = Field(None, description="Optional detailed explanation")
    # Image generation fields
    image_prompt_en: Optional[str] = Field(
        None, description="English prompt for image generation (flat infographic style)"
    )
    image_url: Optional[str] = Field(
        None, description="URL to the generated image for this section"
    )
...
class InfographicStructure(BaseModel):
    ...
    footer_note: Optional[str] = Field(
        None, description="Optional footer note (e.g., source attribution)"
    )
