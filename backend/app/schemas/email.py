...
class EmailContent(BaseModel):
    ...
    speaker_opinions: List[SpeakerOpinion] = Field(
        default_factory=list, description="発言者別意見"
    )
...
class EmailGenerateRequest(BaseModel):
    ...
    document_source_ids: List[UUID] = Field(
        default_factory=list, description="資料ソースID"
    )
