...
class MinuteOut(BaseModel):
    ...
    processing_status: str = Field(default="pending", description="処理状態: pending/processing/completed/failed")
...
class MinuteDetailOut(BaseModel):
    ...
    formatted_content: Optional[str] = Field(None, description="LLMで整形されたコンテンツ")
